...
export type IPCMessageType = 'state_update' | 'log_entry' | 'command' | 'config_update' | 'ide_event' | 'chat_message' | 'file_change' | 'log_batch' | 'cortex_analysis';
...
export type IPCMessage = StateUpdateMessage | LogEntryMessage | LogBatchMessage | CommandMessage | IDEEventMessage | ChatMessage | FileChangeMessage | CortexAnalysisMessage;
