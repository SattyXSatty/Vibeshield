...
* ✅ **Gaps & Failures**: If your input variable is empty, `None`, or contains no useful data, do NOT return an empty object or list silently. Instead, provide a clear explanation in your output (e.g., `{"revenue_data": "Insufficient data available in search results to determine revenue."}`).
